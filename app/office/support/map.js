...
const maps=[ 
    {   
        key:"Support",
        path:"support",
        js:["/modules/office/support/controller.js", "/modules/office/support/service.js"],
        html:"/modules/office/support/views/support.html",
        rule:["Authorized"],
        icon:'<i class="far fa-briefcase"></i>',
        canStick:true
    },
    // {
